...
@extends('layouts.auth-layouts.auth')
                    ...
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Enter your username" required autocomplete="name" autofocus>
